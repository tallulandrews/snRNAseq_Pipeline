...
dev.off();
png(paste(prefix, "scaled_merged_not_integrated_umap.png", sep="_"), width=9, height =6, units="in", res=300)
DimPlot(merged_obj, reduction="umap", group.by="sample", pt.size=0.1)
dev.off();
png(paste(prefix, "scaled_merged_not_integrated_tsne_autoanno.png", sep="_"), width=12, height =6, units="in", res=300)
Type_DimPlot(merged_obj, reduction="tsne", type_col="marker_labs", cluster_col="marker_labs")
dev.off();
png(paste(prefix, "scaled_merged_not_integrated_umap_autoanno.png", sep="_"), width=12, height =6, units="in", res=300)
...
dev.off();
png("SN_SC_rescaled_merged_not_integrated_umap.png", width=9, height =6, units="in", res=300)
...
dev.off();
png("SN_SC_rescaled_merged_not_integrated_umap_autoanno.png", width=12, height =6, units="in", res=300)

...
dir <- "/cluster/projects/macparland/TA/Single_Nuc/Amby"
seurfiles <- c("RAT11-1_SN_EmptyOnly.rds", 
	"RAT9-3_EmptyOnly.rds",
	"RAT9-5_SN_EmptyOnly.rds",
	"RAT6-2_SN_EmptyOnly.rds",
	"RAT6-1_SN_EmptyOnly.rds",
	"RAT6-3_SN_EmptyOnly.rds"
	);

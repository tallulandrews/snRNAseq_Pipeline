...
gene_type <- match_genes(global, gene_type)
...
png("gene_stats_boxplots.png", width=12, height=10, units="in", res=300)
par(mfrow=c(2,3))
boxplot(global_diff ~ gene_type$biotype, xlab="gene_type", ylab="SC-SN", notch=T, col="grey65", las=2)
boxplot(clean_diff ~ utrs_5_clean[,3], xlab="5' UTR", ylab="SC-SN",  notch=T, col="grey65")
boxplot(clean_diff ~ utrs_3_clean[,3], xlab="3' UTR", ylab="SC-SN",  notch=T, col="grey65")
boxplot(clean_diff ~ transcript_length_clean[,3], xlab="Trans length", ylab="SC-SN",  notch=T, col="grey65")
boxplot(clean_diff ~ gene_gc_clean[,3], xlab="GC content", ylab="SC-SN",  notch=T, col="grey65")
boxplot(clean_diff ~ miCount_clean[,3], xlab="miRNA binding sites", ylab="SC-SN",  notch=T, col="grey65")
dev.off()
...
par(mfrow=c(2,2))
boxplot(global_diff ~ gene_type$biotype, xlab="gene_type", ylab="SC-SN", notch=T, col="grey65", las=2)
boxplot(clean_diff ~ lengths_clean[,5], xlab="exon", ylab="SC-SN",  notch=T, col="grey65")
boxplot(clean_diff ~ lengths_clean[,6], xlab="intron", ylab="SC-SN",  notch=T, col="grey65")
boxplot(clean_diff ~ lengths_clean[,7], xlab="n_exon", ylab="SC-SN",  notch=T, col="grey65")
dev.off()
